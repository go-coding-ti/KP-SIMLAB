...
@section('content')
    ...
    <div class="section">
        ...
        <div class="container-sm">
            <!-- row -->
            <div class="row">
                <form method="POST" action="{{route('check-out-satu')}}">
                    @csrf
                    <div class="col-md-8">
                        <!-- Billing Details -->
                    ...
                    <div class="col-md-4 order-details">
                        ...
                        <div class="order-summary">
                            ...
                            @foreach ($laboratoriums as $item)
                                <div class="order-products" id="layanankanan-{{$item->id_laboratorium}}">
                                    <div class="order-col">
                                        <div>{{$item->nama_lab}}</div>
                                        <div class="harga" id="subtotal{{$item->id_laboratorium}}">0</div>
                                    </div>
                                </div>
                            @endforeach
