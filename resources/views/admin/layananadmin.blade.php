...
@section('content')
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <a class="btn btn-success text-white" data-toggle="modal" data-target="#exampleModal"><i
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-primary btn-sm" data-toggle="modal"
                                            data-target="#update{{$layanan1->id_layanan}}"><i class="fa fa-edit"></i>
                                    </button>
                                    <!--Delete -->
                                    <button class="btn btn-danger btn-sm" data-toggle="modal"
                                            data-target="#delete{{$layanan1->id_layanan}}"><i class="fa fa-trash"></i>
                                    </button>
                                </td>
                            </tr>
                        @endforeach
    ...
    @foreach($layanan as $layananModal)
        <!-- Modal Delete -->
            <div class="modal fade" id="delete{{$layananModal->id_layanan}}" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="layananadmin/{{$layananModal->id_layanan}}/delete">
            ...
            <!-- End Modal Delete -->
            <!-- Modal Update -->
            <div class="modal fade" id="update{{$layananModal->id_layanan}}" tabindex="-1" role="dialog"
                 aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <form action="/layananadmin/update" method="POST">
                                    ...
                                    <select name="id_bidang" id="bidang" class="custom-select" required>
                                        ...
                                        @foreach($bidangs as $bidang)
                                            <option value="{{$bidang->id_bidang}}"
                                                    @if($layananModal->id_bidang==$bidang->id_bidang) selected @endif>{{$bidang->nama_bidang}}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="keterangan" name="keterangan"
                                           value="{{$layananModal->keterangan}}" placeholder="">
                                </div>
                                <div class="modal-footer">
