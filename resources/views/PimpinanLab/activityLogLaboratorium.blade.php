                    ...
                    <div class="modal-body">
                        <form class="form-group">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama_lab" value="" readonly>
                            </div>
                            <div class="form-group">
                                <label class="font-weight-bold text-dark">Id Laboratorium</label>
                                <input type="text" class="form-control" id="id_laboratorium" value="" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="no_telp" readonly></textarea>
                            </div>
                            <div class="form-group">
                                <label class="font-weight-bold text-dark">Tanggal</label>
                                <input type="text" class="form-control" id="tanggal" value="" readonly>
                            </div>
                            <img id="lab_image" src="" class="img-fluid img-thumbnail card-img">
                            <div class="form-group">
            ...
            $(document).on('click', '.btn_view', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        document.getElementById("nama_lab").value = object.nama_lab;
                        document.getElementById("id_laboratorium").value = object.id_laboratorium;
                        document.getElementById("user").value = object.relasi_user.name;
                        document.getElementById("alamat").value = object.alamat;
                        document.getElementById("no_telp").value = object.no_telp;
                        ...
                        $("#lab_image").attr("src",object.foto_lab);
                        $('#lihat').modal('show');
                    }
                });
            });
