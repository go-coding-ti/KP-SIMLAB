                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTables" width="100%" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <th style="text-align:center; width:5%">ID Bidang</th>
                    ...
                    <div class="modal-body">
                        <form class="form-group">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama_bidang" value="" readonly>
                            </div>
                            <div class="form-group">
                                <label class="font-weight-bold text-dark">Id Bidang</label>
                                <input type="text" class="form-control" id="id_bidang" value="" readonly>
                            </div>
                            <div class="form-group">
            ...
            $(document).on('click', '.btn_view', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        document.getElementById("nama_bidang").value = object.judul;
                        document.getElementById("id_bidang").value = object.id_berita;
